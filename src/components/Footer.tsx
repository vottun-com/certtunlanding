    ...
    <footer className="relative border-t border-[var(--color-border)] bg-[var(--color-bg-secondary)]">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={i}
                  href="#"
                  className="w-8 h-8 rounded-lg bg-[var(--color-bg-card)] border border-[var(--color-border)] flex items-center justify-center text-[var(--color-text-muted)] hover:text-[var(--color-cyan)] hover:border-[var(--color-cyan)]/30 transition-all"
                >
                  {icon}
                </a>
              ))}
          ...
          {/* Product */}
          <div>
            <h4 className="font-[family-name:var(--font-outfit)] text-sm font-semibold text-white mb-4">
              {t("product")}
            </h4>
            <ul className="space-y-3">
              {[tNav("features"), tNav("howItWorks"), tNav("pricing"), "API Docs"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
